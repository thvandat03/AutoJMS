    ...
    public partial class Main : UIForm
    {
        ...
        private void tabAbout_btnCheckUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Chưa cấu hình link update.", "Update Check Failed", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        private async Task<string> GetPdfUrlViaCSharpAsync(List<string> waybills, int printType, int applyTypeCode)
        {
            ...
            {
                Console.WriteLine($"Lỗi mạng GetPdfUrl: {ex.Message}");
            }
            return null;
        }
